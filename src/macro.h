 ...
 * Z - initial value
 */
#define VOBJ(X,Y,Z) struct ff7_ ## X *ff7_ ## Y = (void *)(Z);

/*
 * VPTR - Access the raw pointer contained in an object.
 * X - object
 */
#define VPTR(X) ((void *)ff7_ ## X)
 ...
 */
#define UNSAFE_VREF(X,Y) ((void *)ff7_ ## X->Y)
